...
class RNNCell(Layer):
    ...
    def __init__(self, n_inputs, n_hidden, n_ouput, activation="sigmoid"):
        super().__init__()
        ...
        self.w_ho = Linear(n_hidden, n_ouput)
        ...
        def init_hidden(self, batch_size=1):
            hidden = np.zeros((batch_size, self.n_hidden))
            return Tensor(hidden, autograd=True)
